About fractal-client-feedstock
==============================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/fractal-client-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/fractal-client-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add fractal-client
# for installing globally
pixi global install fractal-client
```
...
It is possible to list all of the versions of `fractal-client` available on your platform:
...
```
pixi search fractal-client --channel conda-forge
```
